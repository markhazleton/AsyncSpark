...
**Live Site**: [https://async.makeboldspark.com](https://async.makeboldspark.com) | **API Docs**: [/scalar/v1](https://async.makeboldspark.com/scalar/v1)
...
5. **Resilience, Documentation & Logging**: Polly policies, XML documentation, structured logging with ILogger
...
- Live Demo: [async.makeboldspark.com/scalar/v1](https://async.makeboldspark.com/scalar/v1)
...
### WebSpark NuGet Packages by Mark Hazleton

AsyncSpark is powered by open-source NuGet packages authored by [Mark Hazleton](https://markhazleton.com), [Make Bold Solutions](https://makeboldsolutions.com):

| Package | Version | Purpose |
| ------- | ------- | ------- |
| [WebSpark.HttpClientUtility](https://www.nuget.org/packages/WebSpark.HttpClientUtility) | 2.2.0 | Structured HTTP client with telemetry, caching, and resilience built on `IHttpClientFactory` |
| [WebSpark.Bootswatch](https://www.nuget.org/packages/WebSpark.Bootswatch) | 1.34.0 | 25+ Bootswatch Bootstrap themes with tag helper, cookie persistence, and light/dark mode |
| [WebSpark.HttpClientUtility.Crawler](https://www.nuget.org/packages/WebSpark.HttpClientUtility.Crawler) | latest | Async-first website crawler built on HttpClientUtility with CancellationToken support |
...
**WebSpark NuGet Packages** (by [Mark Hazleton](https://markhazleton.com), [Make Bold Solutions](https://makeboldsolutions.com)):

- [WebSpark.HttpClientUtility](https://www.nuget.org/packages/WebSpark.HttpClientUtility) - Structured HTTP client with telemetry and resilience
- [WebSpark.Bootswatch](https://www.nuget.org/packages/WebSpark.Bootswatch) - Bootswatch Bootstrap theme switcher for ASP.NET Core
- [WebSpark.HttpClientUtility.Crawler](https://www.nuget.org/packages/WebSpark.HttpClientUtility.Crawler) - Async website crawler utility
...
**[Mark Hazleton](https://markhazleton.com)** — Solutions Architect, [Make Bold Solutions](https://makeboldsolutions.com)

GitHub: [@markhazleton](https://github.com/markhazleton)

Portfolio: [Make Bold Spark](https://makeboldspark.com)

---

**AsyncSpark** — Production-ready async patterns for .NET 10 | Part of [Make Bold Spark](https://makeboldspark.com) | Built by [Mark Hazleton](https://markhazleton.com), [Make Bold Solutions](https://makeboldsolutions.com)
